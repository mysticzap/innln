 ...
 *
 * ```php
 * $locator = new \innln\di\ServiceLocator;
 ...
 * ```
 *
 * Because [[\innln\base\Module]] extends from ServiceLocator, modules and the application are all service locators.
...
class ServiceLocator extends Component
{
    ...
    public function get($id, $throwException = true)
    {
        ...
        if (isset($this->_definitions[$id])) {
            ...
            return $this->_components[$id] = Innln::createObject($definition);
     ...
     * ```php
     * // a class name
     * $locator->set('cache', 'innln\caching\FileCache');
     *
     ...
     *     return new \innln\caching\FileCache;
     * });
     *
     * // an instance
     * $locator->set('cache', new \innln\caching\FileCache);
     * ```
     *
