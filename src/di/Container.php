...
use ReflectionClass;
use Innln;
use innln\base\Component;
use innln\base\InvalidConfigException;
use innln\helpers\ArrayHelper;
 ...
 *
 * By default, [[\Innln::$container]] refers to a Container instance which is used by [[\Innln::createObject()]]
 ...
 *
 * use innln\base\BaseObject;
 * use innln\db\Connection;
 ...
 * $container->set('innln\db\Connection', [
 *     'dsn' => '...',
 * ]);
 ...
 *
 * $db = new \innln\db\Connection(['dsn' => '...']);
...
class Container extends Component
{
     ...
     *
     * If the class implements [[\innln\base\Configurable]], the `$config` parameter will be passed as the last
     ...
     * @throws NotInstantiableException If resolved to an abstract class or an interface (since 1.0.0)
     */
     ...
     * $container->set('innln\mail\MailInterface', 'innln\swiftmailer\Mailer');
     *
     * // register an alias name. You can use $container->get('foo')
     * // to create an instance of Connection
     * $container->set('foo', 'innln\db\Connection');
     *
     ...
     *     return new \innln\db\Connection($config);
     * });
     * ```
     *
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('innln\base\Configurable')) {
     ...
     *
     * ```php
     * $formatString = function($string, \innln\i18n\Formatter $formatter) {
     *    // ...
     * }
     * Innln::$container->invoke($formatString, ['string' => 'Hello World!']);
     * ```
     *
    ...
    public function resolveCallableDependencies(callable $callback, $params = [])
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            if (($class = $param->getClass()) !== null) {
                ...
                } elseif (isset(Innln::$app) && Innln::$app->has($name) && ($obj = Innln::$app->get($name)) instanceof $className) {
                    $args[] = $obj;
                } else {
     ...
     *     'innln\web\Request' => 'app\components\Request',
     *     'innln\web\Response' => [
